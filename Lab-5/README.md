...
> Arrange the given elements in a 1D array in *ascending* and *descending* order using the ***bubble*** ***sort*** and ***selection sort*** method. 
[Hint: Use `switch`-`case` (As *case ‘a’* and *case 'd'*) to specify the order].
> 
